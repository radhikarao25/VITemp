<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Home.Master" AutoEventWireup="true" CodeBehind="NonRegisteredStudents.aspx.cs" Inherits="AttendanceWebApp.Admin.NonRegisteredStudents" %>
            ...
            <div id="tab-general">
                <div>
                    ...
                    <div class="panel panel-yellow">
                            <div class="panel-heading">List of Non-Registered Students</div>
                            <asp:Label ID="defaultLabel" runat="server" Text="Please select a class and section"></asp:Label>
                            <div class="panel-body">
                                <asp:ListView ID="nonRegisteredStudentsList" runat="server" ItemPlaceholderID="placeHolder1">
                                    <ItemTemplate>
                                        <tr>
